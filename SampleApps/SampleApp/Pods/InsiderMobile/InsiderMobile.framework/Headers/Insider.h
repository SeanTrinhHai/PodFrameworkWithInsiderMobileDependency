...
/**
 This method gives you search result based on the user locale and currency.
 
 @param searchQuery The search query string.
 @param currency The currency of the search.
 @param searchResult The handler method which contains the search result data.
